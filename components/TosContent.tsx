// Shared ToS text — used by both /terms page and the first-visit modal.
...
export default function TosContent() {
  return (
    <article className="prose prose-invert prose-sm max-w-none text-gray-300 [&_h1]:text-white [&_h2]:text-white [&_h2]:text-base [&_h2]:font-semibold [&_h2]:mt-6 [&_p]:text-gray-400 [&_li]:text-gray-400 [&_strong]:text-gray-200">
      ...
      <p>Ask-It provides access to artificial intelligence tools and AI-generated content. Responses are generated automatically and may be inaccurate, incomplete, misleading, offensive, or outdated. Users are solely responsible for verifying any information provided by the Service before relying upon it.</p>

      <h2>3. Eligibility</h2>
      <p>You must be at least 13 years old, or the minimum age required by the laws of your jurisdiction, to use the Service. By using the Service, you represent that you meet these requirements.</p>
      ...
      <p>The Ask-It website, branding, software, design, and related materials remain the property of Ask-It and its operators. Users retain ownership of content they submit to the Service.</p>
